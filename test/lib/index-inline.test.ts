...
describe('Test End 2 End - Inline mode --all-projects', () => {
  it('Test Inline mode strict mode - all-projects - one project - no vuln', async () => {
    setTimeout(() => {
      stdinMock.send(
        fs
          .readFileSync(
            fixturesFolderPath + 'snykTestsOutputs/allProjectsGoofOne.json',
          )
          .toString(),
      );
      stdinMock.send(null);
  ...
  it('Test Inline mode strict mode - all-projects - one project - one new vuln', async () => {
    setTimeout(() => {
      stdinMock.send(
        fs
          .readFileSync(
            fixturesFolderPath +
              'snykTestsOutputs/allProjects-test-goof-two-vuln-one-project.json',
          )
          .toString(),
      );
      stdinMock.send(null);
  ...
  it('Test Inline mode strict mode - all-projects - two project - no vuln', async () => {
    setTimeout(() => {
      stdinMock.send(
        fs
          .readFileSync(
            fixturesFolderPath +
              'snykTestsOutputs/allProjectsGoofTwoProjects.json',
          )
          .toString(),
      );
      stdinMock.send(null);
  ...
  it('Test Inline mode strict mode - all-projects - two project - one new vuln each', async () => {
    setTimeout(() => {
      stdinMock.send(
        fs
          .readFileSync(
            fixturesFolderPath +
              'snykTestsOutputs/allProjects-test-goof-two-Projects-two-vuln-each.json',
          )
          .toString(),
      );
      stdinMock.send(null);
  ...
  it('Test Inline mode strict mode - all-projects - two project - one new vuln in one', async () => {
    setTimeout(() => {
      stdinMock.send(
        fs
          .readFileSync(
