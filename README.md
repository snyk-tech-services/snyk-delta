...
Snyk-delta doesn't currently support the --all-projects option, but you can try to use [snyk_delta_all_projects.sh](./snyk_delta_all_projects.sh) as an example of how to work aroun this.
